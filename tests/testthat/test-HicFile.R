test_that("HicFile works", {
    ...
    expect_equal(resolution(hf1), 1000L)
    ...
    expect_equal(pairsFile(hf1), pairs_path)
    ...
    expect_equal(resolution(ihf1), 1000L)
    expect_equal(pairsFile(ihf1), pairs_path)
    ...
    ihf0 <- import(hic_path, format = 'hic')
    ihf1 <- import(hic_path, pairsFile = pairs_path, format = 'hic')
    ihf2 <- import(hic_path, pairsFile = pairs_path, resolution = 16000, format = 'hic')
    ihf3 <- import(hic_path, resolution = 16000, format = 'hic')
    ...
    ihf3 <- HiCExperiment(hic_path, resolution = 16000, pairsFile = pairs_path)
    expect_equal(resolution(ihf2), 16000L)
