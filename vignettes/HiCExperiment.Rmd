...
[HiC-Pro](https://github.com/nservant/HiC-Pro) (mostly based on `python`), [distiller](https://github.com/open2c/distiller-nf) (mostly coded in `nextflow`) and 
[Juicer](https://github.com/aidenlab/juicer/) (mostly coded in `bash` and `awk`) are the three main pipelines used to 
align, filter and process paired-end fastq reads into pairs files and contact 
matrices. Each pipeline defined their own file formats to store these two types of 
files. 
...
- Contact matrix file formats vary greatly depending on the pipeline: 
