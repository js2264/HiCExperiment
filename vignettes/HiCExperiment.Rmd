...
The `import()` function allows one to import a .(m)cool file in R as an 
...
The `focus` argument is used to spcifically import contacts within a genomic 
locus of interest. 
...
hic <- import(mcool_file, format = 'cool', focus = range, res = 1000)
hic
```
...
```{r}
hic <- import(mcool_file, format = 'cool', focus = 'II:0-500000 x II:100000-600000', res = 2000)
focus(hic)
```
